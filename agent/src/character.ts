...
export const character: Character = {
    ...
    knowledge: [
        { path: "../../agent/Knowledge/basic_knowledge.txt", shared: true },
        { path: "../../agent/Knowledge/chi-cuv.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/chr-cherokee.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/cze-bkr.zefania.txt", shared: true },
        { path: "../../agent/Knowledge/dut-statenvertaling.zefania.txt", shared: true },
        { path: "../../agent/Knowledge/eng-asv.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-bbe.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/eng-darby.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-dra.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-gb-oeb.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-gb-webbe.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/eng-kjv.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-us-oeb.osis.txt", shared: true },
        { path: "../../agent/Knowledge/eng-web.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/eng-ylt.osis.txt", shared: true },
        { path: "../../agent/Knowledge/heb-leningrad.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/jpn-kougo.osis.txt", shared: true },
        { path: "../../agent/Knowledge/lat-clementine.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/por-almeida.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/ron-rccv.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/spa-bes.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/spa-pddpt.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/spa-rv1909.usfx.txt", shared: true },
        { path: "../../agent/Knowledge/spa-vbl.usfx.txt", shared: true }
    ],
    topics: [
        "faith",
        "salvation",
